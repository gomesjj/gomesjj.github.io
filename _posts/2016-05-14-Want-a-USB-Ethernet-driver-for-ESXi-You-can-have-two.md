...
What could be causing this? The only thing I could think of was the fact that on vSwitch1 the ethernet traffic was tagged. Shirley that couldn't be the reason? And it wasn't -- it was routing. I have a Cisco SG300 running on Layer 3 mode (router) and it will happily do inter-VLAN routing, no problem. The difference on ESXi is that with the single TCP/IP stack design there is only one default gateway (unlike most other sensible operating systems). Traffic was hitting the default gateway (VLAN 100), then being re-routed to the ISCSI VLAN (10). That worked fine on egress, but the return trip, bouncing from VLAN to VLAN, was killing the speed.
...
[ax88179-1.14.0-1-esxi60u2.vib](https://bintray.com/gomesjj/VIBs/download_file?file_path=ESXi60%2Fax88179-1.14.0-1-esxi60u2.vib)

#### ESXi 5.5

[ax88179-1.14.0-1-esxi55u3.vib](https://bintray.com/gomesjj/VIBs/download_file?file_path=ESXi55%2Fax88179-1.14.0-1-esxi55u3.vib)

#### ESXi 5.1

[ax88179-1.14.0-1-esxi51u3.vib](https://bintray.com/gomesjj/VIBs/download_file?file_path=ESXi51%2Fax88179-1.14.0-1-esxi51u3.vib)

### Realtek

#### ESXi 6.0

[r8152-2.06.0-1.esxi60u2.vib](https://bintray.com/gomesjj/VIBs/download_file?file_path=ESXi60%2Fr8152-2.06.0-1.esxi60u2.vib)

#### ESXi 5.5

[r8152-2.06.0-1.esxi55u3.vib](https://bintray.com/gomesjj/VIBs/download_file?file_path=ESXi55%2Fr8152-2.06.0-1.esxi55u3.vib)

#### ESXi 5.1

[r8152-2.06.0-1.esxi51u3.vib](https://bintray.com/gomesjj/VIBs/download_file?file_path=ESXi51%2Fr8152-2.06.0-1.esxi51u3.vib)
